...
An R torch implementation of Radial Basis Function (RBF) Layers. This project is a port of [PyTorchRBFLayer](https://github.com/rssalessio/PytorchRBFLayer) adapted for the R ecosystem.
...
Original Python Implementation: [Alessio Russo](https://github.com/rssalessio) (KTH, Sweden)
